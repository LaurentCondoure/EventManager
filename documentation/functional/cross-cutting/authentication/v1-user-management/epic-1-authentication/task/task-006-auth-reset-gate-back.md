# TASK-006 â€” Cross-Cutting / Authentication / back
...
- `must_reset_password = true` in token â†’ 403 `PASSWORD_RESET_REQUIRED`
...
- Exemption of `/auth/reset-password` must be explicit â€” not inferred from route attributes
- Claim is read from the JWT â€” no database call required
